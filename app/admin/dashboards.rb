ActiveAdmin.register_page "Dashboard" do
  ...
  content :title => proc{ I18n.t("active_admin.dashboard") } do
    ...
    panel "Recent Articles", :if => proc {current_user.is_admin? || current_user.is_editor? }, :priority => 1 do
    ...
    panel "Your Articles", :if => proc {current_user.is_writer? }, :priority => 2 do
